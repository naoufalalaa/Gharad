...
<body>
  ...
  <div id="myDropdown" class="dropdown-content">
	...
	<div class="couverture_vi">
				<h1 align="center">Villa à Vendre</h1>
	</div>
 <br>
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Villa à Vendre</h2></center>
	<center>
		...
		<div style="overflow-x:auto" width="100%">
			<table class="table">
	          ...
	          <div class="slidee">
	              ...
	              <div class="carousel-inner">
	                <div class="carousel-item active">
	                  <img class="d-block w-100" src="assets/img/villa/v1.jpeg" alt="First slide">
	                </div>
	                <div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v2.jpeg" alt="Second slide">
	                </div>
	                <div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v3.jpeg" alt="Third slide">
	                </div>
	                <div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v4.jpeg" alt="Fourth slide">
	                </div>
					<div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v5.jpeg" alt="fifth slide">
	                </div>
					<div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v6.jpeg" alt="sixth slide">
	                </div>
					<div class="carousel-item">
	                  <img class="d-block w-100" src="assets/img/villa/v7.jpeg" alt="seventh slide">
	                </div>
	              </div>
				...
				<div class="documentation"><h3>Villa à vendre</h3>
				<p>villa</p><br>
				<p class="last"><b>Contactez le vendeur</B></p><br>
				<p>Contact: 0667949855</p>

					<a id="plus" style="background-color: rgba(40,167, 69, 0.8); color: white; padding:5px" href="appart1.php">voir plus</a>
	          ...
	          <div class="slidee">
				...
				<div class="documentation"><h3>comming Soon</h3>
			<p></p><br>
			<p class="last"><b>450000 DHS</B></p><br>
			<p>Contact: 0667949855</p>
	        ...
	        <td align="center">
			  ...
			  <div class="documentation"><h3>comming Soon</h3>
			<p></p><br>
			<p class="last"><b>xxxxxx DHS</B></p><br>
			<p>Contact: 0667949855</p>
