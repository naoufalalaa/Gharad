...
<body>
	...
	<nav id="navbar">
		<ul id="list">
			...
			<a href="index.php"><li id="selected" align="center"><center>Acceuil</center></li></a>
			...
			</li>			<a href="terrain_vent.php"><li align="center"><center>Terrain</center></li></a>
			<a href="car_vent.php"><li align="center"><center>Véhicules</center></li></a>
...
<div class="carousel-inner">
  ...
  <div class="carousel-item">
	...
	<div class="big-article">
		<center><h2 align="center">Section Immobilier</h2></center>

		<div class="article" id="maison">

			<h1 align="center">Maison</h1>
			<a href="maison_vent.php">
			<div class="vente">
				<p align="center" class="title">Vente</p>
				<p align="center" class="text">Achetez et investissez dans la maison de vos rêves</p>
			</div>
			</a>
			<a href="maison_loc.php"><div class="location">
				<p align="center" class="title">Location</p>
				<p align="center" class="text">Louez une maison convenable et adéquate à vos besoins et à votre bien être familial </p>
				</div></a>
		</div>


		<div class="article" id="villa">
			<h1 align="center">Villa</h1>
			<a href="villa_vent.php">
			<div class="vente">
				<p align="center" class="title">Vente</p>
				<center><p align="center" class="text">Achetez et investissez dans la maison de vos rêves</p></center>
			</div>
			</a>
			<a href="villa_loc.php">
			<div class="location">
				<p align="center" class="title">Location</p>
				<p  align="center" class="text">Louez une maison convenable et adéquate à vos besoins et à votre bien être familial </p>
			</div>
		...
		<div class="article" id="appart">
			<h1 align="center">Appartement</h1>
			<a href="appart_vent.php">
			<div class="vente">
				<p align="center" class="title">Vente</p>
			<center>	<p  align="center" class="text">Achetez et investissez dans la maison de vos rêves</p></center>
				</div></a>
			<a href="appart_loc.php"><div class="location">
				<p align="center" class="title">Location</p>
			<center><p class="text" align="center">Louez une maison convenable et adéquate à vos besoins et à votre bien être familial </p>
			</center>
				</div></a>
