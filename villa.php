...
<head>
      <meta charset="utf-8">
	    ...
	    <meta name="description" content="Gharad Immobilier est une agence spécialisée dans la vente et location des biens de tous genres, Appartements, villas, Villa allant même jusqu'à proposer des projets d'investissement.">
...
<title>Gharad Immobilier villa</title>
...
<body>
	...
	<nav id="navbar">
		<ul id="list">
			...
			<a href="terrain_vent.php"><li align="center"><center>Terrain</center></li></a>
...
<center><h2 style="
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Section villa</h2></center>
	<center>
	<div class="card" style="width: 18rem;">
  <img src="assets/img/v7.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">villa à vendre</h5>
    <p class="card-text">Nous vous montrons les meilleures villas à vendre dans votre région de marrakech.</p>
    <a href="villa_vent.php" class="btn btn-primary">villa à vendre</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img src="assets/img/v2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">villa à louer</h5>
    <p class="card-text">Nous vous montrons les meilleures villas à louer dans la région de marrakech.</p>
    <a href="villa_loc.php" class="btn btn-primary">villa à louer</a>
  </div>
</center>
</div>
