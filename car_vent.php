...
<body>
	...
	<nav id="navbar">
		<ul id="list">
			...
			<a href="car_vent.php"><li id="selected" align="center"><center>Véhicules</center></li>
  ...
  <div id="myDropdown" class="dropdown-content">
	...
	<div class="couverture_v">
				<h1 align="center">Voiture à vendre</h1>
	</div>
 <br>
 <center><h2 style="
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Voiture à Vendre</h2></center>
