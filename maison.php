...
<title>Gharad Immobilier MAISON</title>
...
<center><h2 style="
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Section Maison</h2></center>
	<center>
	<div class="card" style="width: 18rem;">
  <img src="assets/img/9.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Maison à vendre</h5>
    <p class="card-text">Nous vous montrons les meilleures maisons à vendre dans votre région de marrakech.</p>
    <a href="maison_vent.php" class="btn btn-primary">Maison à vendre</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img src="assets/img/cover2M.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Maison à louer</h5>
    <p class="card-text">Nous vous montrons les meilleures maisons à louer dans la région de marrakech.</p>
    <a href="maison_loc.php" class="btn btn-primary">Maison à louer</a>
  </div>
</center>
</div>
