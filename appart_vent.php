...
<title>Appartement à vendre</title>
...
<body>
  ...
  <div id="myDropdown" class="dropdown-content">
	...
	<div class="couverture_ap">
				<h1 align="center">Appartement à Vendre</h1>
	</div>
 <br>
 <center><h2 style="
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Appartement à Vendre</h2></center>
...
<div style="overflow-x:auto">
		<table class="table">
          ...
          <div class="slidee">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="assets/img/appart/a.jpeg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/b.jpeg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/c.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/d.jpeg" alt="Third slide">
                </div>
              </div>
			...
			<div class="documentation"><h3>Appartement Dar Salam</h3>
			<p>Appartement dar salam Route d'Agadir</p><br>
          ...
          <div class="slidee">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="assets/img/appart/comingsoon.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/comingsoon.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/comingsoon.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="assets/img/appart/comingsoon.jpg" alt="Third slide">
                </div>
