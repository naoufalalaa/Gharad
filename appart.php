...
<title>Gharad Immobilier appartement</title>
...
<center><h2 style="
	...
	font-size: medium;
	width: 250px;
	cursor:default;" align="center">Section appartement</h2></center>
	<center>
	<div class="card" style="width: 18rem;">
  <img src="assets/img/a1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Appartement à vendre</h5>
    <p class="card-text">Nous vous montrons les meilleures appartements à vendre dans votre région de marrakech.</p>
    <a href="appart_vent.php" class="btn btn-primary">Appartement à vendre</a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Nous vous montrons les meilleures appartements à louer dans la région de marrakech.</p>
    <a href="appart_loc.php" class="btn btn-primary">Appartement à louer</a>
  </div>
</center>
</div>
